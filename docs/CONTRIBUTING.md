...
Use the table of ![contents icon](/assets/table-of-contents.png)
...
See the [README.md](README.md) to navigate our codebase with confidence :confetti_ball:. The [README.md](README.md) also shows how to run the project locally and has information on the architecture.
