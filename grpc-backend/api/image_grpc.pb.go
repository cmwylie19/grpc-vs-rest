...
func (c *imageClient) StoreImage(ctx context.Context, in *StoreImageRequest, opts ...grpc.CallOption) (*StoreImageResponse, error) {
	out := new(StoreImageResponse)
	err := c.cc.Invoke(ctx, "/images.Image/StoreImage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedImageServer) StoreImage(context.Context, *StoreImageRequest) (*StoreImageResponse, error) {
...
func _Image_StoreImage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StoreImageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImageServer).StoreImage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/images.Image/StoreImage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImageServer).StoreImage(ctx, req.(*StoreImageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Image_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Image_StoreImage_Handler,
		},
	},
